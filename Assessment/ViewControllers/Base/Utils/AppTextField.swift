...
public class AppTextField: UITextField {
    ...
    public var aLayer:CALayer                              = CALayer()
    ...
    public var dtborderStyle:AppBorderStyle = .rounded{
        didSet{
            borderLayer.removeFromSuperlayer()
            switch dtborderStyle {
            case .none:
                aLayer.cornerRadius        = 0.0
                aLayer.borderWidth         = 0.0
            case .rounded:
                aLayer.cornerRadius        = 4.5
            ...
            case .bottom,.left,.right,.top:
                ...
                if dtborderStyle == .bottom {
                    borderLayer.frame = CGRect(x: 0, y: aLayer.bounds.size.height - borderWidth, width: aLayer.bounds.size.width, height: borderWidth)
                }else if dtborderStyle == .left{
                    borderLayer.frame = CGRect(x: 0, y: 0, width: borderWidth, height: aLayer.bounds.size.height)
                }else if dtborderStyle == .right{
                    borderLayer.frame = CGRect(x: aLayer.bounds.size.width - borderWidth, y: 0, width: borderWidth, height: aLayer.bounds.size.height)
                }else{
                    borderLayer.frame = CGRect(x: 0, y: 0, width: aLayer.bounds.size.width, height: borderWidth)
                }
                aLayer.addSublayer(borderLayer)
            }
        }
    }
    ...
    fileprivate var aLayerHeight:CGFloat{
    ...
    override public func clearButtonRect(forBounds bounds: CGRect) -> CGRect {
        ...
        rect.origin.y = (aLayerHeight - rect.size.height) / 2
        return rect
    }
    ...
    override public func layoutSubviews() {
        ...
        aLayer.frame = CGRect(x: bounds.origin.x,
                               y: bounds.origin.y,
                               width: bounds.width,
                               height: aLayerHeight)
        ...
        if showErrorLabel {
            ...
            lblErrorFrame.origin.y = aLayer.frame.origin.y + aLayer.frame.size.height + paddingYErrorLabel
